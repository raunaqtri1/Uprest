...
<link href='http://fonts.googleapis.com/css?family=Oswald:400,300,700' rel='stylesheet' type='text/css'>
	...
	<link rel="stylesheet" href="../site/css/style-article.css">
    <link rel="stylesheet" href="../site/css/style-changebg.css">
   
    	<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
	<script src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
    <script type="text/javascript" src="../js/modernizer.js"></script>
    <script src="../site/js/carousel/jquery.min.js"></script>
		<script src="../site/js/carousel/jquery.dropotron.min.js"></script>
		<script src="../site/js/carousel/skel.min.js"></script>
		<script src="../site/js/carousel/skel-panels.min.js"></script>
		<script src="../site/js/carousel/init.js"></script>
...
<script src="../site/js/main.js"></script> <!-- Resource jQuery -->    
