...
<link href='http://fonts.googleapis.com/css?family=Oswald:400,300,700' rel='stylesheet' type='text/css'>
	...
	<link rel="stylesheet" href="../css/style-article2.css">
...
<body oncontextmenu="return false" class="noselect">
    ...
    <div class="container clearfix">
        <h1 id="logo" style="margin-top:30px;font-size:30px;">
				...
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<div class="cd-select cd-filters">
							<select class="filter" name="selectThis" id="selectThis" style="width:200px;">
   ...
   <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    ...
    <!--follow unfollow------------------------------------------------------------------------>
     ...
     <div class="dashboard">
        ...
        <p style="z-index:400000;"><?php echo strtoupper($_GET['category']);?></p>
    ...
    <main>
        ...
        <div class="showmore" id="scrol">Liked our choice? Read more!</div>
  ...
  @if(isset($_GET['category']))
   ...
   $('#scrol').on('click', function (e) {
        ...
        success: function (data) {
          ...
          strt=data.strtrow;
        for (i = 0; i < 12; i=i+4) {
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news1'><b><span class='headin'>"+data.news.response.docs[i].title[0]+"</span></b><p>Source:"+data.news.response.docs[i].source[0]+"</p><p class='news'>"+data.news.response.docs[i].description+"</p><div class='readmore1'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.news.response.docs[i].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news2'><b><span class='headin'>"+data.news.response.docs[i+1].title[0]+"</span></b><p>Source:"+data.news.response.docs[i+1].source[0]+"</p><p class='news'>"+data.news.response.docs[i+1].description+"</p><div class='readmore2'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.news.response.docs[i+1].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news3'><b><span class='headin'>"+data.news.response.docs[i+2].title[0]+"</span></b><p>Source:"+data.news.response.docs[i+2].source[0]+"</p><p class='news'>"+data.news.response.docs[i+2].description+"</p><div class='readmore3'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.news.response.docs[i+2].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news4'><b><span class='headin'>"+data.news.response.docs[i+3].title[0]+"</span></b><p>Source:"+data.news.response.docs[i+3].source[0]+"</p><p class='news'>"+data.news.response.docs[i+3].description+"</p><div class='readmore3'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.news.response.docs[i+3].description)+"' >...</a></div></div>";  
          }
...
function func(){
 ...
 dat["interests"]=intersst;
  ...
  $.ajax({
        ...
        for (i = 0; i < 12; i=i+4) {
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news1'><b><span class='headin'>"+data.response.docs[i].title[0]+"</span></b><p>Source:"+data.response.docs[i].source[0]+"</p><p class='news'>"+data.response.docs[i].description+"</p><div class='readmore1'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.response.docs[i].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news2'><b><span class='headin'>"+data.response.docs[i+1].title[0]+"</span></b><p>Source:"+data.response.docs[i+1].source[0]+"</p><p class='news'>"+data.response.docs[i+1].description+"</p><div class='readmore2'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.response.docs[i+1].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news3'><b><span class='headin'>"+data.response.docs[i+2].title[0]+"</span></b><p>Source:"+data.response.docs[i+2].source[0]+"</p><p class='news'>"+data.response.docs[i+2].description+"</p><div class='readmore3'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.response.docs[i+2].description)+"' >...</a></div></div>";
          document.getElementById('mainarticle').innerHTML=document.getElementById('mainarticle').innerHTML+"<div class='news4'><b><span class='headin'>"+data.response.docs[i+3].title[0]+"</span></b><p>Source:"+data.response.docs[i+3].source[0]+"</p><p class='news'>"+data.response.docs[i+3].description+"</p><div class='readmore3'><a href='"+<?php echo "\"".$ull."\"";?>+"/page?url="+encodeURI(data.response.docs[i+3].description)+"' >...</a></div></div>";  
          }
