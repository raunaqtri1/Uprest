...
<script>
    ...
    <script src="js/jquery.js" rel="javascript"></script>
		<script src="js/ui.js" rel="javascript"></script>
		<script src="js/myScript.js" rel="javascript"></script>
...
<body oncontextmenu="return false" class="noselect">
	...
	<main class="cd-main-content">
		<div class="cd-fixed-bg cd-bg-1">
            <h1><br/><br/><br/><font color="#ffffff">YOUR PERSONAL MAGAZINE</font><br/>
                <b><font color="white" size="4">Find, follow and collect stories on all the topics you love.</font><br/><br/></b>
...
{{$errors->first('email')}}
		...
		<div class="cd-scrolling-bg cd-color-1">
			...
			<div class="cd-container">
                ...
                <?php $url=action('homecontroller@getIndex');?>
                <div class="containerbox2 floatl">
                    <a href=<?php echo "'".$url."/display?category=football'" ;?>>
...
@endif/>
    ...
    <div id="signupsuccessful" class="modalDialog">
	<div>
		<a href="#close" title="Close" class="close">X</a><br/><br/><br/><br/><br/>
        <h2></h2>
        <br/><br/>
        <p style="text-align:center;color:white;">@if (session('message')) <?php echo session('message');?>@endif</p>
	</div>
</div>
